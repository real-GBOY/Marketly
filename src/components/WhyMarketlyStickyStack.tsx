...
export function WhyMarketlyStickyStack() {
	...
	return (
		<article className='relative z-30 w-full' aria-label={t("subHero.title")}>
			...
			{/* Panel 3 — dark stack cap (brand field) */}
			<section className='relative z-20 flex min-h-[72vh] w-full items-center overflow-hidden bg-brand text-white'>
				<motion.div
					...
					<div className='max-w-[560px] text-left'>
						<BoxReveal boxColor='#d8cce8' duration={0.5}>
							<p className='font-manrope text-sm uppercase tracking-[0.22em] text-white/65'>
								{t("servicesPreview.kicker")}
							</p>
						</BoxReveal>
						<BoxReveal boxColor='#d8cce8' duration={0.55}>
							<h3 className='mt-4 font-raleway text-3xl font-semibold leading-[1.12] tracking-tight md:text-4xl lg:text-5xl'>
								...
								<br />
								<span className='text-[#f3ecff]'>
									{t("whyMarketlyStack.panel3Line2")}
								</span>
							</h3>
						</BoxReveal>
						<BoxReveal boxColor='#d8cce8' duration={0.6}>
						...
						<CardSwap
							...
							<Card customClass='bg-navy text-white shadow-[0_24px_80px_rgba(0,0,0,0.45)]'>
								<div className='flex h-full flex-col justify-between rounded-xl border border-white/10 p-6 md:p-8'>
									<p className='font-manrope text-sm uppercase tracking-[0.2em] text-[#c4b5dc]'>
										{t("servicesPreview.kicker")}
									</p>
									<div>
