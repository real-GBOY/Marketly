			...
			<div className='mx-auto max-w-[1920px] px-5 py-16 md:px-9 md:py-24 lg:px-[137px]'>
				<div className='grid gap-10 lg:grid-cols-[1fr_420px] lg:items-start'>
					<div className='max-w-[860px]'>
						...
						<form
							className='relative mt-10 grid gap-5 overflow-hidden rounded-3xl border border-dividerOnLight bg-gradient-to-b from-white to-slate-50/60 p-6 shadow-[0_14px_44px_rgba(2,6,23,0.08)] md:p-8'
							onSubmit={(e) => {
								e.preventDefault();
								setStatus("success");
							}}>
