	...
	return (
		<section className='bg-transparent' aria-label={t("trialCta.aria")}>
			<div className={`${layoutInset} py-4 md:py-6 lg:py-8`}>
				<div className='overflow-hidden rounded-[1.25rem] border border-black/[0.06] bg-homerunInk text-white shadow-[0_12px_48px_rgba(45,41,38,0.2)] sm:rounded-2xl md:rounded-[2rem]'>
					<div className='px-5 py-14 md:px-8 md:py-16 lg:px-10 lg:py-20'>
						<div className='mx-auto flex max-w-[36rem] flex-col items-center text-center'>
							<div
								...
								aria-hidden>
								<BlueCharIcon className={`${iconClass} translate-y-0`} />
								<Blue2Icon
